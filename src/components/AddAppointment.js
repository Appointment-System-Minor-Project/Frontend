  ...
  const formDataPosted = async() => {
    ...
    if(result.status) {
      ...
      const appointmentInfo = {
        ...
        apt_date: formData.apt_date + " " + formData.apt_time,
          ...
          <div className="sm:grid sm:grid-cols-3 sm:gap-4 sm:items-start  sm:pt-5">
            ...
            <div className="mt-1 sm:mt-0 sm:col-span-2">
              <input
                required
                onChange={(event) => {
                  setFormData({ ...formData, apt_date: event.target.value });
                }}
                type="date"
                name="aptDate"
                id="aptDate"
